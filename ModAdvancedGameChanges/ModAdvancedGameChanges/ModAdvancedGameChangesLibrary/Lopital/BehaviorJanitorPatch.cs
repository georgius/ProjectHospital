...
namespace ModAdvancedGameChanges .Lopital
{
    ...
    public static class BehaviorJanitorPatch
    {
        ...
        public static bool UpdateStateAdminIdlePrefix(float deltaTime, BehaviorJanitor __instance)
        {
            ...
            if (!BehaviorJanitorPatch.HandleGoHomeFulfillNeedsTraining(__instance))
            {
                ...
                {
                    Debug.LogDebug(System.Reflection.MethodBase.GetCurrentMethod(), $"{__instance.m_entity.Name}, managing janitors");
        ...
        public static bool UpdateStateCleaningPrefix(float deltaTime, BehaviorJanitor __instance)
        {
            ...
            if (!__instance.GetComponent<WalkComponent>().IsBusy())
            {
                ...
                {
                    Debug.LogDebug(System.Reflection.MethodBase.GetCurrentMethod(), $"{__instance.m_entity.Name}, needed to go home, to fulfill needs or to go to training");
            ...
            if (!__instance.GetComponent<WalkComponent>().IsBusy())
            {
                ...
                if (!BehaviorJanitorPatch.HandleGoHomeFulfillNeedsTraining(__instance))
                {
                    ...
                    else if ((homeRoomType != null) && homeRoomType.HasTag(Tags.Vanilla.JanitorAdminWorkplace))
                    {
                        ...
                        Debug.LogDebug(System.Reflection.MethodBase.GetCurrentMethod(), $"{__instance.m_entity.Name}, nothing to do, managing janitors");
                    ...
                    else
                    {
                        ...
                        if (__instance.m_state.m_cart != null)
                        {
                            Debug.LogDebug(System.Reflection.MethodBase.GetCurrentMethod(), $"{__instance.m_entity.Name}, going to cart");
                        ...
                        {
                            Debug.LogDebug(System.Reflection.MethodBase.GetCurrentMethod(), $"{__instance.m_entity.Name}, no cart, cleaning");
                ...
                if (!__instance.GetComponent<ProcedureComponent>().IsBusy())
                {
                    ...
                    if (!BehaviorJanitorPatch.HandleGoHomeFulfillNeeds(__instance))
                    {
                        if ((homeRoomType == null)
                            ...
                            || ((homeRoomType != null) && (!homeRoomType.HasTag(Tags.Mod.JanitorTrainingWorkspace)) && (!BehaviorJanitorPatch.HandleGoHomeFulfillNeedsTraining(__instance)) && (!BehaviorJanitorPatch.HandleGoHomeFulfillNeedsGoToWorkplace(__instance))))
                        {
                            // by default, go to common room
                            Vector3i position = MapScriptInterfacePatch.GetRandomFreePlaceInRoomTypePreferDepartment(__instance, RoomTypes.Vanilla.CommonRoom, employeeComponent.m_state.m_department.GetEntity(), AccessRights.STAFF);
        ...
        public static bool UpdateStateReturningCartPrefix(BehaviorJanitor __instance)
        {
            ...
            if (!__instance.GetComponent<WalkComponent>().IsBusy())
            {
                Debug.LogDebug(System.Reflection.MethodBase.GetCurrentMethod(), $"{__instance.m_entity.Name}, returned cart");
        ...
        public static bool UpdateStateWalkingToCartToNextRoomPrefix(BehaviorJanitor __instance)
        {
            ...
            if (!__instance.GetComponent<WalkComponent>().IsBusy())
            {
                Debug.LogDebug(System.Reflection.MethodBase.GetCurrentMethod(), $"{__instance.m_entity.Name}, arrived to cart");

                EmployeeComponent employeeComponent = __instance.GetComponent<EmployeeComponent>();

                if (__instance.m_state.m_cart != null)
                {
                    Debug.LogDebug(System.Reflection.MethodBase.GetCurrentMethod(), $"{__instance.m_entity.Name}, picking up cart");
                ...
                Debug.LogDebug(System.Reflection.MethodBase.GetCurrentMethod(), $"{__instance.m_entity.Name}, cleaning");
        ...
        public static bool HandleGoHomeFulfillNeeds(BehaviorJanitor instance)
        {
            ...
            if (BehaviorJanitorPatch.IsNeededHandleFullfillNeeds(instance))
            {
        ...
        public static bool CanGoToWorkplace(BehaviorJanitor instance)
        {
            EmployeeComponent employeeComponent = instance.GetComponent<EmployeeComponent>();
            ...
            Debug.LogDebug(System.Reflection.MethodBase.GetCurrentMethod(), $"{instance.m_entity.Name}, opposite shift employee: {oppositeShiftEmployee?.Name ?? "NULL"}, state: {oppositeShiftEmployee?.GetComponent<BehaviorJanitor>().m_state.m_janitorState.ToString() ?? "NULL"}");

            return canGoToWorkplace;
        }
        ...
        public static bool HandleGoHomeFulfillNeedsGoToWorkplace(BehaviorJanitor instance)
        {
            if (!BehaviorJanitorPatch.HandleGoHomeFulfillNeeds(instance))
            {
                ...
                if (BehaviorJanitorPatch.CanGoToWorkplace(instance))
                {
                    Debug.LogDebug(System.Reflection.MethodBase.GetCurrentMethod(), $"{instance.m_entity.Name}, can go to workplace");

                    if ((homeRoomType != null) && homeRoomType.HasTag(Tags.Mod.JanitorTrainingWorkspace))
                    {
                        Debug.LogDebug(System.Reflection.MethodBase.GetCurrentMethod(), $"{instance.m_entity.Name}, going to janitor training workplace");
                    ...
                    {
                        Debug.LogDebug(System.Reflection.MethodBase.GetCurrentMethod(), $"{instance.m_entity.Name}, going to janitor admin workplace");
                    ...
                    {
                        Debug.LogDebug(System.Reflection.MethodBase.GetCurrentMethod(), $"{instance.m_entity.Name}, going to janitor workplace");
    ...
    public static class BehaviorJanitorExtensions
    {
        public static void FindCart(this BehaviorJanitor instance)
        {
            MethodAccessHelper.CallMethod(instance, "FindCart");
        }

        public static void FreeObject(this BehaviorJanitor instance)
        {
            MethodAccessHelper.CallMethod(instance, "FreeObject");
        }

        public static void FreeRoom(this BehaviorJanitor instance)
        {
            MethodAccessHelper.CallMethod(instance, "FreeRoom");
        }

        public static void FreeTile(this BehaviorJanitor instance)
        {
            MethodAccessHelper.CallMethod(instance, "FreeTile");
        }

        public static void GoReturnCart(this BehaviorJanitor instance)
        {
            MethodAccessHelper.CallMethod(instance, "GoReturnCart");
        }

        public static TileObject GetWorkDesk(this BehaviorJanitor instance)
        {
            return MethodAccessHelper.CallMethod<TileObject>(instance, "GetWorkDesk");
        }

        public static bool TryToSelectIndoorTile(this BehaviorJanitor instance, int threshold)
        {
            return MethodAccessHelper.CallMethod<bool>(instance, "TryToSelectIndoorTile", threshold);
        }

        public static bool TryToSelectTileInARoom(this BehaviorJanitor instance)
        {
            return MethodAccessHelper.CallMethod<bool>(instance, "TryToSelectTileInARoom");
        }

        public static bool TryToSelectTileInCurrentRoom(this BehaviorJanitor instance)
        {
            return MethodAccessHelper.CallMethod<bool>(instance, "TryToSelectTileInCurrentRoom");
        }

        public static void SelectNextAction(this BehaviorJanitor instance)
        {
            MethodAccessHelper.CallMethod(instance, "SelectNextAction");
        }

        public static void UpdateCleaningTime(this BehaviorJanitor instance)
        {
            MethodAccessHelper.CallMethod(instance, "UpdateCleaningTime");
        }
    }
}
